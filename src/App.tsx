  ...
  return (
    <div className="flex h-screen w-full bg-slate-50 text-slate-900 overflow-hidden font-sans selection:bg-red-100 selection:text-red-900">
      ...
      <div className="flex-1 flex flex-col min-w-0 relative">
        <MilestoneHeader onMenuClick={() => setIsSidebarOpen(true)} />
        
        <main className="flex-1 overflow-y-auto p-4 md:p-6 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-transparent">
